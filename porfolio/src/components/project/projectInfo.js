...
export const arr = [
    {
      ...
      'image': findbook,
      'url': 'https://findbookapp.netlify.app/',
      'urlGit': 'https://github.com/NurCord/FT-FindBook'
    },
    {
      'id': 2,
      'name': 'Search Country',
      ...
      'image': county,
      'url': 'https://challenge-kimche-r.vercel.app/',
      'urlGit': 'https://github.com/NurCord/ChallengeKimcheR'
    },
    {
      'id': 3,
      'name': 'Henry Food',
