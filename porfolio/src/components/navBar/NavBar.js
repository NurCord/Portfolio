    ...
    return (
      <div className={clsx(
            ...
            )}/>
        {
          ...
          <>
            ...
            <div className='flex items-center justify-self-center'>
              <button onClick={modeDark} type="button" data-toggle-dark="dark" class="flex items-center px-2 w-8 h-8 text-xs font-medium text-gray-700 bg-pink-100 rounded-lg border border-gray-500  hover:bg-pink-200 hover:text-black focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
        ...
        <div className='flex'>
          ...
          <button onClick={modeDark} type="button" data-toggle-dark="dark" class="flex items-center px-2 w-10 h-10 text-xs font-medium text-gray-700 bg-pink-100 rounded-lg border border-gray-500  hover:bg-pink-200 hover:text-black focus:z-10 focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500 dark:bg-gray-800 focus:outline-none dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
              <svg aria-hidden="true" data-toggle-icon="moon" class="w-4 h-4 hidden" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
              <svg aria-hidden="true" data-toggle-icon="sun" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
              <span class="sr-only">Toggle dark/light mode</span>
            </button>
          </div>
          ...
          <div id="dropdown" class={`${variable} z-10 h-auto absolute right-16 top-2 bg-pink-300 rounded divide-y divide-pink-300 shadow`}>
              <ul class="py-1 text-sm text-white" aria-labelledby="dropdownDefault">
                <li>
                  <a href="# " class="block py-2 px-4 hover:bg-gray-100">Proyects</a>
                </li>
                <li>
                  <a href="# " class="block py-2 px-4 hover:bg-gray-100">Skills</a>
                </li>
                <li>
                  <a href="# " class="block py-2 px-4 hover:bg-gray-100">Contact</a>
                </li>
              </ul>
          </div>
        </div>
